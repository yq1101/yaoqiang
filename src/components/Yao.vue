...
<script>
    ...
    export default {
        ...
        mounted () {
            axios
                .get('http://localhost/blog/public/index.php/user/index')
                .then(response => (this.info = response.data))
                .catch(function (error) { // 请求失败处理
                    console.log(error);
                });
            axios
                .get('http://localhost/blog/public/index.php/user/tree')
                .then(response => (this.cate = response.data))
                .catch(function (error) { // 请求失败处理
                    console.log(error);
                });
            axios
                .get('http://localhost/blog/public/index.php/user/gfloor')
