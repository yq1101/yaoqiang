  ...
  <div class="top">
    ...
    <div class="i_car">
      <router-link :to="'/cart?id='">
        <div class="car_t"><router-link :to="'/cart'"><a>我的购物车</a></router-link></div>
      </router-link>
    </div>
  </div>
  <!--End Header End-->
...
<!--            <li>{{name}}<div class="ch_img"></div></li>-->
<!--          </ul>-->
          <label>
    ...
    export default {
        ...
        methods:{
            radio:function () {
                ...
                this.isajax=1
                //console.log(_this.attrd_id)
            },
            addcart:function () {
                var num=document.getElementById('num').value
                axios.post(this.url+'/cart/shopcart',{
                    num:num,
                    wid:this.response.id,
                    price:this.response.price,
                    attrd_id:this.response.goods_attr_id,
